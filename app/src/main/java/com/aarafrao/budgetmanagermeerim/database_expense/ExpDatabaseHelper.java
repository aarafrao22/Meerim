...
public abstract class ExpDatabaseHelper extends RoomDatabase {
    ...
    public static synchronized com.aarafrao.budgetmanagermeerim.database_expense.ExpDatabaseHelper getExpense(Context context) {
        if (instance == null) {
            instance = Room.databaseBuilder(context, com.aarafrao.budgetmanagermeerim.database_expense.ExpDatabaseHelper.class, DB_NAME).fallbackToDestructiveMigration().allowMainThreadQueries().build();
